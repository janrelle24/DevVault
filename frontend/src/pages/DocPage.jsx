            ...
            <div className="flex">
                <div className="flex-1 min-w-0 px-6 lg:px-10 py-8 max-w-3xl">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                        <button
                        onClick={copyLink}
                        className="flex items-center gap-1.5 rounded-lg border border-vault-border bg-vault-elevated px-3 py-2 text-xs font-medium text-vault-muted hover:text-vault-text transition-colors"
                        >
                        ...
                        className={`flex items-center gap-1.5 rounded-lg border px-3 py-2 text-xs font-medium transition-colors ${
                            ...
                            : 'border-vault-border bg-vault-elevated text-vault-muted hover:text-vault-text'
                    ...
                    {(doc.content || []).map((block, i) => (
                        ...
                        {block.heading && (
                            <h2 className="text-xl font-bold text-vault-text mb-2">{block.heading}</h2>
                        )}
                        {block.text && (
