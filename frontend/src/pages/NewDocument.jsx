...
export default function NewDocument() {
    ...
    return (
            ...
            <h1 className="text-3xl font-extrabold text-vault-text tracking-tight mb-6">New Document</h1>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <textarea
                    ...
                    rows={2}
                    className="w-full rounded-lg bg-vault-elevated border border-vault-border px-3.5 py-2.5 text-sm text-vault-text outline-none focus:border-vault-accent transition-colors resize-none"
                ...
                <div className="space-y-4">
                    ...
                    <div key={i} className="rounded-lg border border-vault-border bg-vault-elevated p-4 space-y-2.5">
                        ...
                        <input
                            ...
                            className="flex-1 rounded-md bg-vault-bg border border-vault-border px-3 py-2 text-sm text-vault-text outline-none focus:border-vault-accent transition-colors"
                        />
                        {sections.length > 1 && (
                        ...
                        className="w-full rounded-md bg-vault-bg border border-vault-border px-3 py-2 text-sm text-vault-text outline-none focus:border-vault-accent transition-colors resize-none"
                        />
                        <input
                        value={s.code}
